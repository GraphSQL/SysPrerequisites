...
build_time_vars = {'AC_APPLE_UNIVERSAL_BUILD': 0,
 ...
 'BLDSHARED': 'gcc -pthread -shared -Wl,-rpath /usr/local/lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 ...
 'CONFIG_ARGS': "'--prefix=/usr/local' '--enable-unicode=ucs4' '--enable-shared' 'LDFLAGS=-Wl,-rpath /usr/local/lib'",
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-rpath /usr/local/lib',
 'LIBC': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/home/graph/gsql_pkgs/Python-2.7.6:',
 ...
 'TESTPYTHON': 'LD_LIBRARY_PATH=/home/graph/gsql_pkgs/Python-2.7.6: ./python -Wd -3 -E -tt',
 'TESTPYTHONOPTS': '',
 ...
 'abs_builddir': '/home/graph/gsql_pkgs/Python-2.7.6',
 'abs_srcdir': '/home/graph/gsql_pkgs/Python-2.7.6',
